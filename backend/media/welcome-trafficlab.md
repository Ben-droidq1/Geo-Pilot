...
Built on the TrafficLab 3D engine, originally developed by Yuk.
...
GeoPilot is a conversational geospatial intelligence co-pilot. It uses the TrafficLab engine to provide:
...
GeoPilot combines calibrated CCTV footage, satellite context, computer vision, and a digital twin view so users can explore and reason about a real traffic scene through natural conversation.

Get started by navigating to any tabs on the top left corner of the program.

---

## 2. GeoPilot's Engine Functionality

---

The current GeoPilot engine is spread across 3 main tabs. You can navigate to any of these tabs without losing work on another.
